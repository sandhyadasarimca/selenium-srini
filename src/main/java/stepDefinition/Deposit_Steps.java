...
public class Deposit_Steps {
	...
	public void deposit() {
		...
		driver.findElement(By.xpath("//input[@name='ammount']")).sendKeys("332");
		driver.findElement(By.xpath("//input[@name='desc']")).sendKeys("account created by amount");
